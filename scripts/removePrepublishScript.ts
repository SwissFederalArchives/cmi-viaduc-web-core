...
/*
	`10.03.2020/sbe:
	In Angular 9 ist zurzeit nicht erlaubt, Ivy-kompilierte Libraries zu publizieren (zwecks Kompatibilität).
	...
	Mit Angular 10 sollte der Publish mit Ivy möglich sein und dann kann dieses Script entfernt werden.
	*/
